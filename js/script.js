...
var countDownDate = new Date("july 11, 2024 19:00:00").getTime();
...
// sr.reveal(`.rajat`,{ delay: 300, origin: 'top' })
sr.reveal(`.rajat`, { origin: 'left', delay: 200 })
sr.reveal(`.vastu`, { origin: 'right', delay: 400 })
sr.reveal(`.gif,.home_txt`, { delay: 600, origin: 'top' })
